...
public interface ApplicationRepository extends JpaRepository<Application, Long> {
    ...
    @Query("select new com.incubator.application.ApplicationList(a.id, u.fName, u.lName, u.mI, u.rank, u.dob, a.status, a.dateSubmitted) from Application a, User u where a.user = u order by u.lName")
